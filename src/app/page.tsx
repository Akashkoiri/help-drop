...
export default async function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FAFAFA] dark:bg-[#0A0A0A] flex flex-col items-center overflow-hidden font-sans">
      {/* Navbar */}
      <header className="absolute top-0 left-0 w-full p-6 z-50 flex items-center justify-between max-w-[1400px] mx-auto right-0">
        ...
        <div className="flex items-center gap-6">
          ...
          {!userId ? (
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/sign-up"
                className="hidden md:flex items-center justify-center px-4 py-2 text-sm font-medium text-white dark:text-black bg-black dark:bg-white rounded-xl transition-transform hover:scale-[1.02] active:scale-[0.98]"
              >
                Sign Up
              </Link>
            </div>
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] opacity-30 dark:opacity-20 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-black/10 dark:from-white/10 to-transparent blur-3xl rounded-full mix-blend-multiply dark:mix-blend-screen" />
      </div>

      <main className="relative z-10 w-full flex flex-col items-center">
        {/* Hero Section */}
        <section className="w-full max-w-[1000px] mx-auto px-6 pt-32 md:pt-40 pb-24 flex flex-col items-center text-center">
          {/* Soft Beta Tag */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-black/5 dark:border-white/10 bg-white/50 dark:bg-black/50 text-xs font-medium text-black/60 dark:text-white/60 mb-8 backdrop-blur-md">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
            <MagneticButton>
              <Link
                href="/dashboard"
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 text-sm font-medium text-white dark:text-black bg-black dark:bg-white rounded-xl shadow-[0_0_40px_rgba(0,0,0,0.1)] dark:shadow-[0_0_40px_rgba(255,255,255,0.1)] transition-transform hover:scale-[1.02] active:scale-[0.98]"
              >
          ...
          <div className="mt-20 md:mt-32 w-full relative max-w-4xl mx-auto">
            <div className="relative rounded-[24px] border border-black/5 dark:border-white/10 bg-white/40 dark:bg-black/40 backdrop-blur-xl p-2 shadow-2xl shadow-black/5 dark:shadow-white/5">
              <div className="rounded-[16px] border border-black/5 dark:border-white/10 bg-white dark:bg-[#111] overflow-hidden">
                {/* Fake Window Controls */}
                <div className="h-12 border-b border-black/5 dark:border-white/5 flex items-center px-4 bg-black/[0.02] dark:bg-white/[0.02]">
                ...
                <div className="p-6 md:p-10 space-y-4">
                  ...
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-start gap-4 p-4 rounded-xl border border-black/5 dark:border-white/5 hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors"
                    >
                      <div className="mt-0.5 w-5 h-5 rounded-full border border-black/10 dark:border-white/20 flex items-center justify-center flex-shrink-0">
        ...
        <section className="w-full max-w-5xl mx-auto mt-24 md:mt-32 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="p-8 rounded-[24px] border border-black/5 dark:border-white/10 bg-white/40 dark:bg-black/40 backdrop-blur-xl text-left hover:bg-white/60 dark:hover:bg-white/[0.02] transition-colors">
        ...
        <section className="w-full max-w-5xl mx-auto mt-24 mb-32 px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-10 rounded-[32px] bg-black text-white dark:bg-white dark:text-black relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 dark:bg-black/10 blur-[60px] rounded-full translate-x-1/2 -translate-y-1/2" />
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  <h3 className="text-3xl font-semibold tracking-tight mb-4">
                    Focus on what matters.
                  </h3>
                  <p className="text-white/70 dark:text-black/70 text-lg max-w-sm">
            ...
            <div className="grid grid-rows-2 gap-6">
              <div className="p-8 rounded-[32px] border border-black/5 dark:border-white/10 bg-white/40 dark:bg-black/40 backdrop-blur-xl flex flex-col justify-center hover:bg-white/60 dark:hover:bg-white/[0.02] transition-colors">
      ...
      {/* Footer */}
      <footer className="w-full py-8 border-t border-black/5 dark:border-white/10 bg-white/40 dark:bg-black/40 backdrop-blur-md mt-auto">
